...
Mở terminal hoặc command prompt và cài đặt các thư viện cần thiết: Bash 

* 
`# Cài đặt các thư viện cơ bản cho xử lý ngôn ngữ và đồ thị` `pip install networkx matplotlib neo4j openai pandas` 
* 
...
Sử dụng LLM để đọc bộ dữ liệu "Tech Company Corpus" và chuyển đổi thành các bộ ba (Triples). (trong `dataset/`)
